...
export class Backend implements backendInterface {
    ...
    async addProductCategory(arg0: ProductCategory): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addProductCategory(to_candid_ProductCategory_n9(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createProjectBrief(arg0: ProjectBrief): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createProjectBrief(to_candid_ProjectBrief_n18(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initializeProductCategories(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeProductCategories();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async requestConsultation(arg0: ConsultationRequest): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.requestConsultation(to_candid_ConsultationRequest_n50(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ConsultationRequest_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ConsultationRequest): ConsultationRequest {
    return from_candid_record_n31(_uploadFile, _downloadFile, value);
}
function from_candid_Designer_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Designer): Designer {
    return from_candid_record_n34(_uploadFile, _downloadFile, value);
}
function from_candid_PortfolioItem_n36(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PortfolioItem): PortfolioItem {
    return from_candid_record_n37(_uploadFile, _downloadFile, value);
}
function from_candid_ProductCategory_n39(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProductCategory): ProductCategory {
    return from_candid_record_n40(_uploadFile, _downloadFile, value);
}
function from_candid_Product_n42(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Product): Product {
    return from_candid_record_n43(_uploadFile, _downloadFile, value);
}
function from_candid_ProjectBrief_n47(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProjectBrief): ProjectBrief {
    return from_candid_record_n48(_uploadFile, _downloadFile, value);
}
function from_candid_RoomType_n44(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RoomType): RoomType {
    return from_candid_variant_n45(_uploadFile, _downloadFile, value);
}
function from_candid_StylePreference_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _StylePreference): StylePreference {
...
function from_candid_opt_n46(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ProjectBrief]): ProjectBrief | null {
    return value.length === 0 ? null : from_candid_ProjectBrief_n47(_uploadFile, _downloadFile, value[0]);
}
function from_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        stylePreferences: from_candid_vec_n24(_uploadFile, _downloadFile, value.stylePreferences),
        phone: value.phone
    };
}
function from_candid_record_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        status: value.status,
        userId: value.userId,
        projectId: record_opt_to_undefined(from_candid_opt_n23(_uploadFile, _downloadFile, value.projectId)),
        notes: value.notes,
...
function from_candid_record_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        bio: value.bio,
        portfolio: from_candid_vec_n35(_uploadFile, _downloadFile, value.portfolio),
        styles: from_candid_vec_n24(_uploadFile, _downloadFile, value.styles),
        name: value.name
    };
}
function from_candid_record_n37(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        style: from_candid_StylePreference_n25(_uploadFile, _downloadFile, value.style),
...
function from_candid_record_n40(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        description: value.description,
        products: from_candid_vec_n41(_uploadFile, _downloadFile, value.products)
    };
}
function from_candid_record_n43(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        stylePreference: from_candid_StylePreference_n25(_uploadFile, _downloadFile, value.stylePreference),
        name: value.name,
        description: value.description,
        imageUrl: value.imageUrl,
        priceINR: value.priceINR,
        roomType: from_candid_RoomType_n44(_uploadFile, _downloadFile, value.roomType)
    };
}
function from_candid_record_n48(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        userId: value.userId,
        submissionDate: value.submissionDate,
        selectedPackage: record_opt_to_undefined(from_candid_opt_n23(_uploadFile, _downloadFile, value.selectedPackage)),
        stylePreferences: from_candid_vec_n24(_uploadFile, _downloadFile, value.stylePreferences),
        budget: value.budget,
        roomType: from_candid_RoomType_n44(_uploadFile, _downloadFile, value.roomType),
...
function from_candid_vec_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_StylePreference>): Array<StylePreference> {
    return value.map((x)=>from_candid_StylePreference_n25(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ConsultationRequest>): Array<ConsultationRequest> {
    return value.map((x)=>from_candid_ConsultationRequest_n30(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Designer>): Array<Designer> {
    return value.map((x)=>from_candid_Designer_n33(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PortfolioItem>): Array<PortfolioItem> {
    return value.map((x)=>from_candid_PortfolioItem_n36(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n38(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ProductCategory>): Array<ProductCategory> {
    return value.map((x)=>from_candid_ProductCategory_n39(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n41(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Product>): Array<Product> {
    return value.map((x)=>from_candid_Product_n42(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n49(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ProjectBrief>): Array<ProjectBrief> {
    return value.map((x)=>from_candid_ProjectBrief_n47(_uploadFile, _downloadFile, x));
}
function to_candid_ConsultationRequest_n50(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ConsultationRequest): _ConsultationRequest {
...
function to_candid_Product_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Product): _Product {
    return to_candid_record_n13(_uploadFile, _downloadFile, value);
}
function to_candid_ProjectBrief_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProjectBrief): _ProjectBrief {
...
function to_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        description: value.description,
        products: to_candid_vec_n11(_uploadFile, _downloadFile, value.products)
    };
}
function to_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        stylePreference: to_candid_StylePreference_n6(_uploadFile, _downloadFile, value.stylePreference),
        name: value.name,
        description: value.description,
        imageUrl: value.imageUrl,
        priceINR: value.priceINR,
        roomType: to_candid_RoomType_n14(_uploadFile, _downloadFile, value.roomType)
    };
}
...
function to_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<Product>): Array<_Product> {
    return value.map((x)=>to_candid_Product_n12(_uploadFile, _downloadFile, x));
}
